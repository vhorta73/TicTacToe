...
my @board_test = (
  { 
    ...
    init_args   => {}, 
    tests       => [
      { method_name => 'hasAWinner', expected => 0, },
      { method_name => 'getWinner',  expected => undef, },
    ]
  },
  { 
  ...
  { 
    ...
    tests       => [
      { method_name => 'hasAWinner', expected => 1, },
      { method_name => 'getWinner',  expected => 1, },
    ]
  },
  { 
  ...
  { 
    ...
    tests       => [
      { method_name => 'hasAWinner', expected => 1, },
      { method_name => 'getWinner',  expected => 2, },
    ]
  },
